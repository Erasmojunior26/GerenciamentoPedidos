...
namespace PedidoDeCompra.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public VendedoresController(dbPedidoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vendedors != null ? 
                          ...
                          Problem("Entity set 'dbPedidoContext.Vendedors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'dbPedidoContext.Vendedors'  is null.");
            }
            var vendedor = await _context.Vendedors.FindAsync(id);
            if (vendedor != null)
            {
